...
function imprimeAssentos(Ingresso $ingressos){
    ...
    foreach ($ingressos as $ingresso){
        if($ingresso->getFileira()==='A'){
            $assentos[0][$ingresso->getAssento()-1] = '- ';
        }else if($ingresso->getFileira()==='B'){
            $assentos[1][$ingresso->getAssento()-1] = '- ';
        }else if($ingresso->getFileira()==='C'){
            $assentos[2][$ingresso->getAssento()-1] = '- ';
        }else if($ingresso->getFileira()=='D'){
            $assentos[3][$ingresso->getAssento()-1] = '- ';
        }else if($ingresso->getFileira()=='E'){
            $assentos[4][$ingresso->getAssento()-1] = '- ';
        }
    }
...
function aa(){
    ...
    if($sessoes!=null){
        ...
        $codigo = readline();
            ...
            $sessao = $sessaoPDO->findById($codigo);
            $capacidade = $sessao->getSala()->getCapacidade();
            $ingressos = $ingressoPDO->findById($sessao->getId());
            ...
            for ($i=1; $i<=$capacidade; $i++){
                if($i>=1 && $i<=10){
                    ...
                    array_push($filaB, ($i-10));
                }else if($i>=21 && $i<=30){
                    array_push($filaC, ($i-20));
                }else if($i>=31 && $i<=40){
                    array_push($filaD, ($i-30));
                }else if($i>=41 && $i<=50){
                    array_push($filaE, ($i-40));
                }
            }
        ...
        echo "\nAssentos disponiveis: \n";
         ...
         foreach ($ingressos as $ingresso){
             if($ingresso->getFileira()=='A'){
                 $keyA = array_search($ingresso->getAssento(), $filaA);
             }else if ($ingresso->getFileira()=='B'){
                 $keyB = array_search($ingresso->getAssento(), $filaB);
             }else if($ingresso->getFileira()=='C'){
                 $keyC = array_search($ingresso->getAssento(), $filaC);
             }else if($ingresso->getFileira()=='D'){
                 $keyD = array_search($ingresso->getAssento(), $filaD);
             }
         }
            ...
            echo "\n Qual fileira você deseja ?";
            $ingresso->setFileira(readline());

            echo "\nQual assento você deseja?";
            $ingresso->setAssento(readline());

            echo "\nQual o tipo de entrada (inteira('1') ou meia('2')";
            $ingresso->setTipo(readline());


            if($ingressoPDO->insert($ingresso)){
                echo "\nIngresso vendido";
            }else{
                echo "\nNão foi possível vender o Ingresso.";
            }
...
//
//$ingresso->setTipo(1);
//$ingresso->setSessao(20);
//$ingresso->setAssento('A12');
...
//$sessao = new Sessao();
//
//$sessao->setDataSessao('12/12/2018');
//$sessao->setHoraSessao('22:00');
//$sessao->setValorInteira(20.0);
//$sessao->setValorMeia(10.0);
//$sessao->setEncerrada(0);
//
//
//$sessao->setFilme($filme);
//print_r($sessao);

//if($sessaoPDO->insert($sessao, $filme, $ingresso, $sala)){
//    echo "Deu certo";
//}else {
//    echo "Deu errado";
//}
